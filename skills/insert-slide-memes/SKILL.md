...
8. Verify the source and reuse status. For Korean candidates, follow the Korean source hierarchy and internal-training capture fallback in the playbook instead of treating a search result or repost as provenance. Download or capture chosen assets locally; never hotlink third-party images.
